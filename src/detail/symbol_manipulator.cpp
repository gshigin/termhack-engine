...
auto generate_words(std::size_t length, std::size_t count, uint32_t rng_state) noexcept -> std::array<std::string, 20> {
  ...
  if (length == 7) {
    word_array = {"NATASHA", "HIMSELF", "WITHOUT", "THOUGHT", "ANOTHER", "GENERAL", "THROUGH", "AGAINST", "BETWEEN", "NOTHING", "EMPEROR", "BECAUSE", "DISEASE",
  ...
  if (length == 10) {
    word_array = {"GOVERNMENT", "EVERYTHING", "UNDERSTAND", "ESPECIALLY", "EXPRESSION", "THEMSELVES", "IMPOSSIBLE", "PETERSBURG", "CONDITIONS", "UNDERSTOOD",
